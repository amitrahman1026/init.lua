					...
					function()
						if config_exists({ ".clang-format" }) then
							...
							return {
								exe = "clang-format",
								args = {
									"--style='{BasedOnStyle: llvm, IndentWidth: 4, TabWidth: 4, AccessModifierOffset: -4, AllowShortFunctionsOnASingleLine: All, AllowShortIfStatementsOnASingleLine: AllIfsAndElse, AlwaysBreakTemplateDeclarations: Yes}'",
								},
								stdin = true,
							}
						end
